            ...
            children: [
              ...
              Expanded(
                child: Container(
                  ...
                  child: Column(
                    mainAxisAlignment:
                        widget.isBool == false ? MainAxisAlignment.spaceAround : MainAxisAlignment.spaceEvenly,
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          InkWell(
                                            onTap: () {
                                              if (count == 1) {
                                                Fluttertoast.showToast(msg: "It's minimum limit");
                                              } else {
                                                setState(() {
                                                  count--;
                                                });
                                            ...
                                            child: Icon(Icons.remove, color: primaryColor, size: 25),
                                          ),
                                          Text(
                                            "$count",
              ...
              widget.isBool == false ? Container() : Divider(height: 2, color: Colors.black)
            ],
          ),
        ),
      ],
